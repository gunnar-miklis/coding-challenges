...
console.log(
	createPhoneNumber3(	[1, 2, 3, 4, 5, 6, 7, 8, 9, 0] ),
);
...
const getMilitaryTime = function( input ) {
	return input.slice( -2 ) === 'AM' ?
		...
		input.slice( 0, 2 ) === '01' ? '13' + input.slice( 2, -2 ) :	// if 01PM do 13:00
		input.slice( 0, 2 ) === '02' ? '14' + input.slice( 2, -2 ) :
		input.slice( 0, 2 ) === '03' ? '15' + input.slice( 2, -2 ) :
		input.slice( 0, 2 ) === '04' ? '16' + input.slice( 2, -2 ) :
		input.slice( 0, 2 ) === '05' ? '17' + input.slice( 2, -2 ) :
		input.slice( 0, 2 ) === '06' ? '18' + input.slice( 2, -2 ) :
		input.slice( 0, 2 ) === '07' ? '19' + input.slice( 2, -2 ) :
		input.slice( 0, 2 ) === '08' ? '20' + input.slice( 2, -2 ) :
		input.slice( 0, 2 ) === '09' ? '21' + input.slice( 2, -2 ) :
		input.slice( 0, 2 ) === '10' ? '22' + input.slice( 2, -2 ) :
		input.slice( 0, 2 ) === '11' ? '23' + input.slice( 2, -2 ) :
		input.slice( 0, 2 ) === '12' ? '12' + input.slice( 2, -2 ) :
		false;
};
console.log(
