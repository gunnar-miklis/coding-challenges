...
function dirReduc2(directions) {
  ...
  dirCounter.NORTH > dirCounter.SOUTH
    ? (timesToReduceDirY = dirCounter.SOUTH - 1)
    : (timesToReduceDirY = dirCounter.NORTH - 1);
  timesToReduceDirY;
  ...
  dirCounter.EAST > dirCounter.WEST
    ? (timesToReduceDirX = dirCounter.WEST - 1)
    : (timesToReduceDirX = dirCounter.EAST - 1);
  timesToReduceDirX;
...
console.log(dirReduc2(['NORTH', 'WEST', 'SOUTH', 'EAST']));
// should :>> [West, East] but does [ 'WEST', 'WEST', 'EAST', 'EAST' ]
console.log(dirReduc2(['WEST', 'WEST', 'EAST', 'EAST']));
