...
console.log(AlanAnnoyingKid2('Today I played football.'));
console.log(AlanAnnoyingKid2("Today I didn't play football."));
console.log(AlanAnnoyingKid2("Today I didn't attempt to hardcode this Kata."));
