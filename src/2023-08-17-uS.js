...
function generateChatRoomNames(users) {
  ...
  return users.map((user) => {
    ...
    const isEqualLastNameIntital =
      lastNameInitials[firstNames.indexOf(firstName)] ===
      lastNameInitials[firstNames.lastIndexOf(firstName)];
...
console.log(generateChatRoomNames(['JOE Bloggs', 'John Smith'])); // :>> ["Joe", "John"]
console.log(generateChatRoomNames(['Joe Bloggs', 'John Smith', 'Jane Doe'])); // :>> ["Jane", "Joe", "John"]
console.log(generateChatRoomNames(['Joe Bloggs', 'John Smith', 'Jane Doe', 'Jane Bloggs'])); // :>> ["Jane B", "Jane D", "Joe", "John"]
console.log(
  generateChatRoomNames(['Joe Bloggs', 'John Smith', 'Jane Doe', 'Jane Bloggs', 'John Scott']),
